...
public class MainCliente {
    ...
    * Puerto
    * */
    //si el puerto es diferente no se conectara por eso deben ser el mismo
    private final static int PORT = 5000;
    /**
    * Host
    * */
    //local host= este mismo computador
    ...
    public static void main(String[] args) {
        ...
        try {            
            ...
            while( !exit ){//ciclo repetitivo                                
                ...
                //cual es nombre con nombre dels ervidor, con el mismo puerto
